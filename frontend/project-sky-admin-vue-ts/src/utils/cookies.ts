...
export const setPrint = (printInfo: object) => Cookies.set(printKey, JSON.stringify(printInfo));
export const removePrint = () => Cookies.remove(printKey);

// 获取消息
const newData = 'new';
export const getNewData = () => Cookies.get(newData);
export const setNewData = (value: object) => Cookies.set(newData, JSON.stringify(value));
